...
print("Finished loading other datasets. --------------")
...
print("Finished one hot ecoding categorical data. -----------")
...
print("Finished creating training promo time series. -----------")
...
print("Finished creating training set time series. ----------")
...
print("Processing store and item class. ")
...
print("Finished preparing datasets and _-------------")
...
df_preds.reset_index().to_csv('./artifacts/lgb_cv.csv', index=False)
df_2017.to_csv("./artifacts/df_2017.csv", index=False)
...
submission.to_csv('./artifacts/ori_lgb_sub.csv', float_format='%.4f', index=None)
